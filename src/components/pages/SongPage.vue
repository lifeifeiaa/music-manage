  ...
  <div class="table">
      ...
      <el-table-column label="歌词" align="center">
        <template slot-scope="scope">
          <ul style="height: 100px;overflow: scroll">
            <li style="list-style: none" v-for="(item,index) in parseLyric(scope.row.lyric)" :key="index">
              {{item}}
            </li>
          </ul>
        </template>
    ...
    <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
      <el-form :model="registerForm" ref="registerForm" label-width="80px" action="" id="tf">
        ...
        <div>
          <label>歌词</label>
          <input type="textarea" name="lyric"></input>
        </div>
        <div>
          <label>歌曲上传</label>
      ...
      <span slot="footer">
        ...
        <el-button size="mini" @click="addSong">确认</el-button>
      </span>
    </el-dialog>
...
<script>
  ...
  import {songBySingerId,updateSong,delSong} from "../../api";
  export default {
    mixins:[mixin],
    name: "SongPage",
    data(){
